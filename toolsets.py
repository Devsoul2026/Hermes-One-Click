...
_HERMES_CORE_TOOLS = [
    ...
    "terminal", "process",
    # Windows visual desktop actions (hidden outside desktop mode by check_fn)
    "desktop_open_url", "desktop_open_app",
    # File manipulation
...
TOOLSETS = {
    ...
    "desktop": {
        "description": "Windows visual app desktop actions for opening URLs and approved local apps",
        "tools": ["desktop_open_url", "desktop_open_app"],
        "includes": []
    },
