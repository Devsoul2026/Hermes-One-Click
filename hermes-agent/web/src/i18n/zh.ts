...
export const zh: Translations = {
  ...
  pluginsPage: {
    ...
    installUrlPlaceholder: "owner/repo 或 https://...",
    loadHubFailed: "无法加载插件中心数据",
  },
  ...
  oauth: {
    ...
    expiresIn: "{time}后过期",
    startLoginFailed: "无法启动登录",
    loginStatusFailed: "登录 {status}",
    pollingFailed: "轮询失败",
    submitFailed: "提交失败",
    retryFailed: "重试失败",
  ...
  chat: {
    sessionTokenUnavailable:
      "缺少会话令牌。请通过 `hermes dashboard` 打开此页面，不要直接访问文件 URL。",
    authFailedBanner: "认证失败。请刷新页面以更新会话令牌。",
    localhostOnlyBanner: "对话仅可从本机（localhost）访问。",
    copyLastTitle: "将最后一条助手回复复制为原始 Markdown",
    copyLastAria: "复制最后一条助手回复",
    copied: "已复制",
    copyLastLabel: "复制最后回复",
    loadingChat: "正在加载对话…",
  },
  ...
  chatSidebar: {
    ...
    eventsDisconnected: "事件流已断开 — 工具调用可能无法显示",
    eventsRejected: "事件流被拒绝（{code}）— 请刷新页面",
  },
  ...
  modelPicker: {
    ...
    pickProvider: "请先选择提供商 →",
    noModelsMatchFilter: "没有符合筛选的模型",
    noModelsForProvider: "该提供商下列出的模型为空",
    persistGlobal: "全局持久化（否则仅本会话）",
    savesConfigHint: "保存到 config.yaml — 对新会话生效。",
  ...
  modelsPage: {
    ...
    useAs: {
      button: "用作",
      mainModel: "主模型",
      auxiliaryHeading: "辅助任务",
      allAuxiliary: "全部辅助任务",
      current: "当前",
      missingProviderModel: "缺少提供商或模型",
    },
    card: {
      mainBadge: "主",
      auxBadge: "辅",
