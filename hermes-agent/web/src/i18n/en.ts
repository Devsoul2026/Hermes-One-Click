...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    installUrlPlaceholder: "owner/repo or https://...",
    loadHubFailed: "Could not load plugins hub",
  },
  ...
  modelPicker: {
    ...
    savesConfigHint: "Saves to config.yaml — applies to new sessions.",
  ...
  modelsPage: {
    ...
    useAs: {
      ...
      auxiliaryHeading: "Auxiliary task",
      allAuxiliary: "All auxiliary tasks",
      current: "current",
    ...
    settings: {
      ...
      setAuxiliaryTitle: "Set Auxiliary: {task}",
    },
    auxTasks: {
    ...
    modelInfoCard: {
      ...
      overrideAuto: "(override — auto: {auto})",
