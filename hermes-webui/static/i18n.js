...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_factory_reset_prompt: 'Reset provider/model setup and reopen the first-run wizard? Chat sessions will be kept.',
    settings_factory_reset_password_prompt: 'Access password is enabled. Enter your password to authorize the wipe:',
    settings_factory_reset_done: 'Initial setup reset. Reopening setup wizard…',
    ...
    platforms_panel_intro:
      'The Hermes gateway (hermes-agent) can chat on Telegram, Discord, Feishu, WeCom, Slack, and more, plus OpenAI-compatible HTTP (api_server) and custom webhooks. Configure each under platforms.<name> in your active profile config.yaml.',
    ...
    titlebar_view_version_hint: 'Hermes agent version and mirror update',
    ...
    titlebar_about_hint: 'Hermes open-source components',
    titlebar_business_coop: 'Business cooperation',
    titlebar_business_coop_hint: 'Partnership and collaboration',
    titlebar_skill_market: 'Skill Market',
    titlebar_skill_market_hint: 'Browse & install Hermes skills',
    titlebar_github_hint: 'Hermes One-Click repository on GitHub',
    ...
    about_community_blurb:
      'We want everyone to use AI in daily study and work with near-zero friction: fewer buzzwords, more hands-on demos and practical tips. We care about accessible AI, responsible use, and real outcomes. Follow and chat with us on Douyin and Xiaohongshu\u2014let\u2019s build a friendly community for everyday AI practice.',
    about_agent_heading: 'hermes-agent',
    about_agent_blurb:
      'Open-source AI agent runtime by Nous Research. It provides chat, tools, skills, scheduling, and gateway integrations used with this Web UI.',
    about_agent_copyright: 'Copyright (c) 2025 Nous Research',
    about_webui_heading: 'hermes-webui',
    about_webui_blurb:
      'Open-source browser interface for Hermes. This app bundles the Web UI with the agent for local use.',
    about_webui_copyright: 'Copyright (c) 2025 Hermes Web UI Contributors',
    agent_version_loading: 'Loading\u2026',
    agent_version_modal_title: 'Hermes agent',
    ...
    agent_version_update_confirm_title: 'Update Hermes agent?',
    ...
    onboarding_title: 'Welcome to Hermes One-Click',
    ...
    workspace_picker_native_hint: 'A Windows folder dialog will open on this machine. Select the folder you want Hermes to use as the workspace.',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    titlebar_view_version_hint: 'Hermesエージェントのバージョンとミラー更新',
    agent_version_loading: '読み込み中\u2026',
    agent_version_modal_title: 'Hermes エージェント',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    onboarding_title: 'Bienvenido a Hermes One-Click',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    onboarding_title: 'Willkommen bei Hermes One-Click',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_factory_reset_desc: '\u6e05\u7406 provider/model \u914d\u7f6e\u3001\u5feb\u901f\u914d\u7f6e\u5199\u5165\u7684 API key \u548c Web UI \u5bc6\u7801\uff0c\u7136\u540e\u91cd\u65b0\u6253\u5f00\u521d\u59cb\u5316\u5411\u5bfc\u3002\u804a\u5929\u4f1a\u8bdd\u4f1a\u4fdd\u7559\u3002',
    settings_factory_reset_btn: '\u91cd\u7f6e\u914d\u7f6e\u2026',
    settings_factory_reset_prompt: '\u786e\u5b9a\u8981\u91cd\u7f6e provider/model \u914d\u7f6e\u5e76\u91cd\u65b0\u6253\u5f00\u521d\u59cb\u5316\u5411\u5bfc\u5417\uff1f\u804a\u5929\u4f1a\u8bdd\u4f1a\u4fdd\u7559\u3002',
    settings_factory_reset_password_prompt: '\u5df2\u542f\u7528\u8bbf\u95ee\u5bc6\u7801\u3002\u8bf7\u8f93\u5165\u5bc6\u7801\u4ee5\u6388\u6743\u6b64\u6e05\u9664\uff1a',
    settings_factory_reset_done: '\u5df2\u91cd\u7f6e\u521d\u59cb\u914d\u7f6e\uff0c\u6b63\u5728\u91cd\u65b0\u6253\u5f00\u5411\u5bfc\u2026',
    settings_factory_reset_failed: '\u91cd\u7f6e\u914d\u7f6e\u5931\u8d25\uff1a',
    ...
    platforms_panel_intro:
      'Hermes \u7f51\u5173\uff08hermes-agent\uff09\u53ef\u63a5\u5165 Telegram\u3001Discord\u3001\u98de\u4e66\u3001\u4f01\u5fae\u3001Slack \u7b49\u804a\u5929\u5e73\u53f0\uff0c\u4e5f\u652f\u6301 OpenAI \u517c\u5bb9 HTTP\uff08api_server\uff09\u4e0e\u81ea\u5b9a\u4e49 webhook\u3002\u5728\u5f53\u524d profile \u7684 config.yaml \u4e2d\u914d\u7f6e platforms.<\u540d\u79f0>\u3002',
    ...
    titlebar_view_version_hint: '查看 Hermes Agent 版本与国内镜像状态',
    ...
    titlebar_skill_market: '技能市场',
    titlebar_skill_market_hint: '浏览并安装 Hermes 技能包',
    titlebar_github_hint: 'Hermes One-Click GitHub 开源仓库',
    ...
    about_community_blurb:
      '\u6211\u4eec\u5e0c\u671b\u666e\u901a\u4eba\u4e5f\u80fd\u96f6\u95e8\u69db\u628a AI \u7528\u8fdb\u65e5\u5e38\u5b66\u4e60\u4e0e\u5de5\u4f5c\uff1a\u5c11\u6982\u5ff5\u5806\u7801\uff0c\u591a\u53ef\u590d\u7528\u7684\u4e0a\u624b\u6f14\u793a\u4e0e\u63d0\u6548\u5957\u8def\uff1b\u4e5f\u5173\u6ce8 AI \u666e\u53ca\u3001\u8d1f\u8d23\u4efb\u5730\u4f7f\u7528\u4e0e\u771f\u5b9e\u4ea7\u51fa\u3002\u6b22\u8fce\u5728\u6296\u97f3\u3001\u5c0f\u7ea2\u4e66\u4e00\u8d77\u56f4\u89c2\u3001\u63d0\u95ee\u4e0e\u4ea4\u6d41\uff0c\u5171\u5efa\u8f7b\u677e\u4e92\u52a9\u7684 AI \u5b9e\u8df5\u793e\u533a\u3002',
    about_agent_heading: 'hermes-agent',
    about_agent_blurb:
      '由 Nous Research 维护的开源 AI Agent 运行时，为本界面提供对话、工具、技能、定时任务与网关等能力。',
    about_agent_copyright: 'Copyright (c) 2025 Nous Research',
    about_webui_heading: 'hermes-webui',
    about_webui_blurb: '与 Hermes 配套的开源浏览器界面；本应用在本地组合 Web UI 与 Agent 以便使用。',
    about_webui_copyright: 'Copyright (c) 2025 Hermes Web UI Contributors',
    agent_version_loading: '加载中\u2026',
    agent_version_modal_title: 'Hermes Agent 版本',
    ...
    oc_btn_label: '更新',
    oc_btn_hint: '检查 Hermes One-Click 更新',
    oc_modal_title: 'Hermes One-Click 更新',
    oc_checking: '检查更新中…',
    ...
    workspace_picker_native_hint: '将打开 Windows 文件夹选择窗口。请选择你希望 Hermes 使用的工作区文件夹。',
    ...
    settings_section_preferences_meta: 'Hermes Web UI 的默认值与界面行为。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    platforms_panel_intro:
      'Hermes \u7db2\u95dc\uff08hermes-agent\uff09\u53ef\u9023\u63a5 Telegram\u3001Discord\u3001\u98db\u66f8\u3001\u4f01\u5fae\u3001Slack \u7b49\uff0c\u4e26\u652f\u63f4 OpenAI \u76f8\u5bb9 HTTP\uff08api_server\uff09\u8207\u81ea\u8a02 webhook\u3002\u65bc\u76ee\u524d\u914d\u7f6e\u6a94\u7684 config.yaml \u8a2d\u5b9a platforms.<\u540d\u7a31>\u3002',
    platforms_yaml_block: 'config.yaml \u952e',
    ...
    tab_settings: '\u8a2d\u5b9a',
    titlebar_view_version: '\u67e5\u770b\u7248\u672c',
    titlebar_view_version_hint: '\u67e5\u770b Hermes Agent \u7248\u672c\u8207\u93e1\u50cf\u72c0\u614b',
    ...
    titlebar_skill_market: '\u6280\u80fd\u5e02\u5834',
    titlebar_skill_market_hint: '\u700f\u89bd\u4e26\u5b89\u88dd Hermes \u6280\u80fd\u5305',
    titlebar_github_hint: 'Hermes One-Click GitHub \u958b\u6e90\u5009\u5eab',
    ...
    about_brand_name: '\u5192\u7238\u804aAI',
    about_channel_douyin: '\u6296\u97f3',
    about_channel_feishu: '\u98db\u66f8',
    about_community_blurb:
      '\u6211\u5011\u5e0c\u671b\u666e\u901a\u4eba\u4e5f\u80fd\u96f6\u9580\u6abb\u628a AI \u7528\u9032\u65e5\u5e38\u5b78\u7fd2\u8207\u5de5\u4f5c\uff1a\u5c11\u6982\u5ff5\u5806\u78fd\uff0c\u591a\u53ef\u8907\u7528\u7684\u4e0a\u624b\u6f14\u793a\u8207\u63d0\u6548\u5957\u8def\uff1b\u4e5f\u95dc\u6ce8 AI \u666e\u53ca\u3001\u8ca0\u8cac\u4efb\u5730\u4f7f\u7528\u8207\u771f\u5be6\u7522\u51fa\u3002\u6b61\u8fce\u5728\u6296\u97f3\u3001\u5c0f\u7d05\u66f8\u4e00\u8d77\u570d\u89c0\u3001\u63d0\u554f\u8207\u4ea4\u6d41\uff0c\u5171\u5efa\u8f7b\u9b06\u4e92\u52a9\u7684 AI \u5be6\u8e10\u793e\u5340\u3002',
    about_agent_heading: 'hermes-agent',
    about_agent_blurb:
      '\u7531 Nous Research \u7dad\u8b77\u7684\u958b\u6e90 AI Agent \u57f7\u884c\u6642\u74b0\uff0c\u70ba\u672c\u4ecb\u9762\u63d0\u4f9b\u5c0d\u8a71\u3001\u5de5\u5177\u3001\u6280\u80fd\u3001\u6392\u7a0b\u8207\u7db2\u95dc\u7b49\u80fd\u529b\u3002',
    about_agent_copyright: 'Copyright (c) 2025 Nous Research',
    about_webui_heading: 'hermes-webui',
    about_webui_blurb:
      '\u8207 Hermes \u914d\u5957\u7684\u958b\u6e90\u700f\u89bd\u5668\u4ecb\u9762\uff1b\u672c\u61c9\u7528\u5728\u672c\u6a5f\u7d44\u5408 Web UI \u8207 Agent \u4ee5\u4fbf\u4f7f\u7528\u3002',
    about_webui_copyright: 'Copyright (c) 2025 Hermes Web UI Contributors',
    ...
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 Hermes One-Click',
    onboarding_unknown: '\u672a\u77e5',
  ...
  pt: {
    ...
    onboarding_language_label: 'Idioma',
    onboarding_title: 'Bem-vindo ao Hermes One-Click',
...
// Active locale — Hermes One-Click defaults to Chinese; loadLocale() refines from storage.
