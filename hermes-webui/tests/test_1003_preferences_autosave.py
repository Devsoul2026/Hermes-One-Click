...
- All 12 preference fields use _schedulePreferencesAutosave (not _markSettingsDirty)
- Password field MUST still call _markSettingsDirty (security: never autosave)
- _preferencesPayloadFromUi covers all 12 fields
...
def test_all_12_preference_fields_have_autosave_payload_entries():
    """_preferencesPayloadFromUi must include all 12 preference fields."""
