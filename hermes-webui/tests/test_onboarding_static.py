...
def test_index_contains_onboarding_overlay_markup():
    ...
    assert 'id="onboardingLangRow"' in html
...
def test_onboarding_js_exposes_bootstrap_hooks():
    ...
    assert "function setOnboardingLocale(" in js
...
def test_onboarding_uses_i18n_helpers():
    ...
    assert "onboarding_title: 'Welcome to Hermes One-Click'" in i18n
    assert "onboarding_title: 'Bienvenido a Hermes One-Click'" in i18n
