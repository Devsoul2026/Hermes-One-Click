...
_HERMES_BEHAVIORAL_VARS = frozenset({
    ...
    "HERMES_EXEC_ASK",
    "HERMES_HOME_MODE",
    "HERMES_WINDOWS_SAFE_SKILLS_FILE",
    "HERMES_WINDOWS_SKILL_SAFE_MODE",
    "BROWSER_CDP_URL",
    "CAMOFOX_URL",
})
...
def _hermetic_environment(tmp_path, monkeypatch):
    ...
    # Most legacy skill tests assert generic platform behavior. Tests for the
    # Windows allowlist opt in explicitly.
