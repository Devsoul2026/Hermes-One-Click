...
class AIAgent:
    ...
    def __init__(
        ...
        # Optional auxiliary.compression.context_length (feasibility check + detection).
        ...
        # for reliable tool-calling workflows (see MINIMUM_CONTEXT_LENGTH).
        ...
        if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"model.context_length in config.yaml to override detection, or set "
                f"HERMES_MINIMUM_CONTEXT_LENGTH to lower the floor (e.g. 4096)."
            )
    ...
    def _check_compression_model_feasibility(self) -> None:
        ...
        Local GGUF models often expose 8K–32K windows — we never hard-reject
        them here; instead we auto-lower the live session compression threshold
        to fit the auxiliary model when needed.
        ...
        try:
            ...
            if aux_context < threshold:
                ...
                _sr = getattr(self.context_compressor, "summary_target_ratio", 0.20)
                self.context_compressor.tail_token_budget = int(new_threshold * _sr)
